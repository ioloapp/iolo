...
import {SecretSymmetricCryptoMaterial} from "../../.dfx/local/canisters/iolo_backend/service.did";
...
export function createSecret(secretType: SecretType, idPrefix?: string, appendix?: string): AddSecretArgs {
    ...
    const symmetricCryptoMaterial: SecretSymmetricCryptoMaterial = {
        encrypted_symmetric_key: key, // TODO: replace with encrypted key, currently sending the key as plaintext because vetkd library is not working in Jest
