...
import {AddSecretArgs, Result, Result_5, SmartVaultErr} from "../../src/declarations/iccrypt_backend/iccrypt_backend.did";
...
//beforeAll(async () => {
//    const vetkd_wasm = fs.readFileSync('./tests/iccrypt-tests-js/wasm/ic_vetkd_utils_bg.wasm');
