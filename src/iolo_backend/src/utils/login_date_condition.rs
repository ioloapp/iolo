...
use crate::policies::conditions_manager::check_login_date_conditions;
...
pub fn init_login_date_conditions_checks() {
...
fn start_with_interval_secs(secs: u64) {
    ...
    let timer_id = ic_cdk_timers::set_timer_interval(secs, check_login_date_conditions);
