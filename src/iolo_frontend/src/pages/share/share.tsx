...
import {ROUTE_CONTACTS} from "../../components/layout/routes";
...
export function ShareId() {
    ...
    let url = hostname + ROUTE_CONTACTS + '?action=addContactWithDeepLink&principalType=' + currentUser.type + '&principalId=' + currentUser.id;
    if (currentUser.name) {
